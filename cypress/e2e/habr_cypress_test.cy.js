...
//     });
// });
// четвертый тест закончен

// первый раздел
// Заявка на ферификацию студента
// describe('авторизация', () => {
//     it('None-existent login test', () => {
//         cy.fixture('cypressTest').then(data => {
//             cy.log('Переход на страницу авторизации')
...
//         });
//     });
// }); уаыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыы
...
// НЕГАТИВНАЯ ВЕРСИЯ ВЕРИФИКАЦИИ

// describe('НЕГАТИВНАЯ ВЕРСИЯ ВЕРИФИКАЦИИ', () => {
//     it('None-existent login test', () => {
//         cy.fixture('cypressTest').then(data => {
//             cy.log('Переход на страницу авторизации')
//             cy.visit(data.login_url)
